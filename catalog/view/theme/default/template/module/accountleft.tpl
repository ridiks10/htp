      ...
      <ul class="navigation">
         ...
         <li class="mm-dropdown <?php echo $route === 'account/price' || $route === 'account/price/create' || $route === 'account/price/payconfirm' || $route === 'account/price/show_invoice' ? "active open" : ''  ?>">
          ...
          <ul>
            <li class="<?php echo $route === 'account/price' ? "active" : ''  ?>">
              <a tabindex="-1" href="<?php echo $self -> url -> link('account/price', '', 'SSL'); ?>"><span class="mm-text"><?php echo $lang['detail_investment']; ?></span></a>
            </li>
           
            <li class="<?php echo $route === 'account/price/create' ? "active" : ''  ?>">
              <a tabindex="-1" href="<?php echo $self -> url -> link('account/price/create', '', 'SSL'); ?>"><span class="mm-text"><?php echo $lang['create_investment']; ?></span></a>
            </li>
          </ul>
        </li>
        ...
        <li class="mm-dropdown <?php echo $route === 'account/refferal' || $route === 'account/personal' ? "active open" : ''  ?>">
          <a href="#"><i class="menu-icon fa fa-sitemap">
            </i><span class="mm-text"><?php echo $lang['affiliate'] ?></span></a>
          <ul>
            <li class="<?php echo $route === 'account/refferal' ? "active" : ''  ?>">
              <a tabindex="-1" href="<?php echo $self -> url -> link('account/refferal', '', 'SSL'); ?>"><span class="mm-text"><?php echo $lang['Refferal(S)'] ?></span></a>
            </li>
            <li class="<?php echo $route === 'account/personal' ? "active" : ''  ?>">
              <a tabindex="-1" href="<?php echo $self -> url -> link('account/personal', '', 'SSL'); ?>"><span class="mm-text"><?php echo $lang['downlineTree'] ?></span></a>
            </li>
          </ul>
        </li>
